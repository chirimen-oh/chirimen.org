...
スコットランドの[ウィリアム・クルックシャンク](https://en.wikipedia.org/wiki/William_Cruickshank_(chemist))は、ボルタ電堆を横向きに寝かせることで「トラフ電池」を考案し、漏れの問題を解決した。

![トラフ電池はボルタ電堆の漏れの問題を解決した](./assets/what-is-a-battery/trough-battery.jpg)

もうひとつの問題である短い寿命は、不純物による亜鉛の劣化と、銅の表面に水素の泡が蓄積することが原因だった。
1835年、[ウィリアム・スタージャン](https://en.wikipedia.org/wiki/William_Sturgeon)は、亜鉛を水銀で処理することでこの劣化を防げることを発見した。

イギリスの化学者[ジョン・フレデリック・ダニエル](https://en.wikipedia.org/wiki/John_Frederic_Daniell)は、水素と反応する2つ目の電解質を使うことで、銅のカソード表面での水素の蓄積を防いだ。
...
その後1881年、[カミーユ・アルフォンス・フォール](https://en.wikipedia.org/wiki/Camille_Alphonse_Faure)は、鉛のシートを板状に成形することでプランテの設計を改良した。
...
1950年代、ユニオン・カーバイド社（のちに「エバレディ」、さらに「エナジャイザー」として知られるようになる）のルイス・アーリー、ポール・マーサル、カール・コルデシュは、1899年に[ヴァルデマール・ユングナー](https://en.wikipedia.org/wiki/Waldemar_Jungner)が考案した電池の化学方式をもとに、塩化アンモニウムの電解質を[アルカリ性](https://ja.wikipedia.org/wiki/アルカリ性)の物質に置き換えた。
...
1970年代、[COMSAT](https://en.wikipedia.org/wiki/COMSAT)は通信衛星向けにニッケル水素電池を開発した。
