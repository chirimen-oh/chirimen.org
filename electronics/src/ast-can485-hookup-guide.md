...
はんだ付けに不慣れな場合は、[はんだ付けの基本（スルーホール編）](./how-to-solder-through-hole-soldering.md)のチュートリアルを確認してほしい。
...
詳しくは、後述の[CAN入門](#can入門)の節を参照してほしい。
...
詳しくは、後述の[RS485入門](#rs485入門)の節を参照してほしい。
...
Arduinoライブラリを一度もインストールしたことがない場合は、先に[ライブラリのインストールガイド](https://learn.sparkfun.com/tutorials/installing-an-arduino-library)を確認してほしい。
...
> より詳しい情報は、後述の[まとめ・参考資料](#まとめ参考資料)を参照してほしい。
