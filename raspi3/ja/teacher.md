...
- 簡単に試せるが試すだけでは学べないこともある
  - 学習者が各自のペースで独学できるよう書かれており、チュートリアル以外のサンプルと合わせて各自で試しながら進めることを推奨します
  - JavaScript の基礎構文などは別の教材で別途学習する必要があります
- 講師のサポートがあると可能性は無限大
  - 試行錯誤や失敗を通じて学ぶことを想定した教材です。
  - 実践的環境を意図しているため、応用性と自由度も高くなっており、この環境で開発できるものは指導側のスキル次第で大きく広がります
- 
