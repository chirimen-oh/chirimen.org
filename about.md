...
現在、CHIRIMEN コミュニティでは最新の CHIRIMEN 環境を Raspberry Pi 3 などのデバイスに向けにメンテナンスしており、このサイトではその使い方を学ぶためのチュートリアルを掲載しています。

## CHIRIMEN for Raspi3 を試すには
...
[CHIRIMEN for Raspberry Pi3 のチュートリアルサイトはこちら](https://tutorial.chirimen.org/raspi3/ja/)

<!--
## CHIRIMEN for TY51822r3 を試すには

CHIRIMEN TY51822r3 を試すには、[ファームウェアの書き換え](https://tutorial.chirimen.org/ty51822r3/ja/bridge)を行ってください。

[CHIRIMEN for TY51822r3 のチュートリアルサイトはこちら](https://tutorial.chirimen.org/ty51822r3/ja/)
-->
