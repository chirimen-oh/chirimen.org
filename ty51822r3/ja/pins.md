...
なお、SCL、SDA のピンは [Web I2C API](http://browserobo.github.io/WebI2C) で使用するピンです。このピンの配置は CHIRIMEN for TY51822r3 環境でのもので、`MBED 公式の TY51822r3 のピン配置とは異なる事に注意してください。`
