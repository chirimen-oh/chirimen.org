...
## 13.1. webSocketとpub/sub services
### 13.1.1. システム構成
...
#### 13.1.2.3. relayServer.js を使ったプログラムの流れ

##### 13.1.2.3.1. 初期化（受信側、送信側共通の処理
