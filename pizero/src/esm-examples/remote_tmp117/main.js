// ===================================================
// TMP117 高精度温度センサーの値を WebSocket で送信するプログラム
// ===================================================

// --- ライブラリの読み込み ---
// I2C通信（センサーとのデータのやりとり）に使うライブラリ
import { requestI2CAccess } from "node-web-i2c";
// TMP117（高精度に温度を測れるセンサー）を動かすためのライブラリ
...
// TMP117センサーを初期化（使えるようにする）
const tmp117 = new TMP117(i2cPort, 0x48);
await tmp117.init();
console.log("TMP117センサーの準備ができました");

// --- WebSocketリレーの準備 ---
// リレーサーバーに接続
const relay = RelayServer("chirimentest", "chirimenSocket");
// データを送れる「チャンネル」を作る
const channel = await relay.subscribe("chirimenTMP117");
