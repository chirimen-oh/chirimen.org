# リモート3軸加速度センサ(ADXL345)

## 配線図

![配線図](../adxl345/schematic.png "schematic")
...
[pc/index.html](https://codesandbox.io/s/github/chirimen-oh/chirimen.org/tree/master/pizero/src/esm-examples/remote_adxl345/pc?module=pc.js)を起動します。
