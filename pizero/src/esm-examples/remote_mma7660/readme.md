# リモート3軸加速度センサ(MMA7660)

## 配線図

![配線図1](../mma7660/schematic.png "schematic")
...
[pc/index.html](https://codesandbox.io/s/github/chirimen-oh/chirimen.org/tree/master/pizero/src/esm-examples/remote_mma7660/pc?module=pc.js)を起動します。
