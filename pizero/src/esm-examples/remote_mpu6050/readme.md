# リモート３軸ジャイロ＋３軸加速度センサ(MPU6050)

## 回路図

![回路図](../mpu6050/schematic.png "schematic")
...
[pc/index.html](https://codesandbox.io/s/github/chirimen-oh/chirimen.org/tree/master/pizero/src/esm-examples/remote_mpu6050/pc?module=pc.js)を起動します。
